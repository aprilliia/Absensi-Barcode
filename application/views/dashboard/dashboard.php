...
<section class='content'>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="box box-primary box-rounded ">
                <div class="box-header with-border rounded">
                    <h3 class="box-title">Total Pengguna Berdasarkan Penempatan</h3>
        ...
        <div class="col-md-6">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Total Pengguna Berdasarkan Kategori</h3>
                    <div class="box-tools pull-right">
                        <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                        </button>
                    </div>
    ...
    <div>
        <script>
            ...
            $(document).ready(function() {
                var color_array1 = ['#82F2D9', '#7F9AFC', '#F2594A', '#F28C4B', '#7E6F6A', '#36AFB2', '#9c6db2', '#d24a67', '#89a958', '#00739a', '#BDBDBD',
                ...
                donut2.options.data.forEach(function(label, i) {
                    var legendItem = $('<span></span><br/>').text(label['label'] + " ( " + label['value'] + " )").prepend('<i>&nbsp &nbsp;</i>');
                    legendItem.find('i')
                ...
                var color_array2 = ['#7FD9FC', '#829BF2', '#F2594A', '#F28C4B', '#7E6F6A', '#36AFB2', '#9c6db2', '#d24a67', '#89a958', '#00739a', '#BDBDBD'];
...
<div class="col-md-12">
    <div class="box box-widget widget-user">
        <div class="widget-user-header bg-primary-active">
            <br/>
            <p style="text-align: center;">
                <span style="font-family: georgia, palatino; font-size: 15pt;">Selamat datang di  Sistem Absensi Digital</span>
            </p>
            <br/>
        ...
        <br/>
            <img class="img-circle" src="<?php echo base_url() ?>assets/dist/img/logo.png" alt="User Avatar">
        </div>
        <div class="box-footer">
            <div class="row">
                ...
                <div class="col-sm-4 border-right">
                 <br/>
                    <center>
                        <i>Sistem Absensi Digital berbasis QR CODE</i><br>
